          ...
          <div class="form-group">
            ...
            <br>      
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-lg col-md-3 btn-primary">{{ __('adminstaticword.Save') }}</button>&emsp;&emsp;&emsp;
                <a href="{{URL::to('/course')}}/ {{request()->route('id')}}/{{ $cor->slug}}" target="_blank" class="btn btn-lg col-md-3 btn-info">Preview Course Overview</a>&emsp;&emsp;&emsp;
                <a href="{{URL::to('/coursecontent')}}/ {{request()->route('id')}}/{{ $cor->slug}}" target="_blank" class="btn btn-lg col-md-3 btn-success">Preview Course Detail</a>
              </div>
