                                            ...
                                            <button class="btn btn-link" data-toggle="collapse" data-target="#collapseTwo{{ $chapter->id }}" aria-expanded="false" aria-controls="collapseTwo">
                                                ...
                                                <div class="col-lg-8 col-6">
                                                    ...
                                                    @if($course->involvement_request == 1)
                                                        ...
                                                        <a href="{{ route('instructor.profile', $chapter->user->id) }}">- {{ __('frontstaticword.by') }} {{$chapter->user['fname']}} </a>
                                                        @endif
                                                    @endif
                                                </div>
                                                              ...
                                                              <div class="koh-tab-content-body">
                                                                <div class="koh-faq">
                                                                  <div class="koh-faq-question">
                                                                    ...
                                                                    <span class="koh-faq-question-span"> {{ $class['title'] }} {{ $class['type'] }} </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-sm-8">
                                <div class="instructor-block">
                                    <div class="instructor-name btm-10"><a href="{{ route('instructor.profile', $course->user->id) }}" title="instructor-name">{{ $course->user['fname'] }} {{ $course->user['lname'] }}</a></div>
                                                  ...
                                                  <div class="panel panel-sum">
                                                    <div class="modal-body">
                                                        <!-- php
                                                            $courses = App\Course::first();
                                                        endphp -->
                                                        <form id="journalForm" method="post" class="form-horizontal form-label-left">
                                                            {{ csrf_field() }}
