									    ...
									    <div class="creditCardForm">
										    ...
										    <div class="payment">
										        <form accept-charset="UTF-8" action="{{route('stripe.pay')}}" method="POST"autocomplete="off">
										            ...
										            <button class='form-control btn btn-default' type='submit'>{{ __('frontstaticword.Proceed') }} 1</button>
										        </form>
										    </div>
										</div>
							        </div>
									    ...
									    <div class="creditCardForm">
										    ...
										    <div class="payment">
										        <form accept-charset="UTF-8" action="{{route('stripe.pay')}}" method="POST"autocomplete="off">
										            ...
										            <button class='form-control btn btn-default' type='submit'>{{ __('frontstaticword.Proceed') }} with Stripe</button>
										        </form>
										    </div>
										</div>
							        </div>
