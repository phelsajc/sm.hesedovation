            ...
            <form action="{{url('batch/')}}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }} 
                ...
                <br>
                  ...
                  <select class="form-control js-example-basic-single" name="allowed_courses[]" multiple="multiple" size="5" row="5" placeholder="Select Courses">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control js-example-basic-single" name="allowed_users[]" multiple="multiple" size="5" row="5" placeholder="Select Users">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <textarea id="detail" name="detail" rows="5"  class="form-control" placeholder="Enter Your Detail" ></textarea>
                </div>
              </div>
              <br>
