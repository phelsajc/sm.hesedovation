  ...
  Route::middleware(['IsInstalled' ,'switch_languages', 'ip_block'])->group(function () {
    ...
    Route::middleware(['is_active', 'auth', 'maintanance_mode'])->group(function () {
        ...
        Route::middleware(['is_admin'])->group(function () {
            ...
            Route::post('/quickupdate/course_reject/{id}','QuickUpdateController@courseQuickReject')->name('course.quick_reject'); #course reject
            Route::post('/quickupdate/course_live/{id}','QuickUpdateController@courseQuickLive')->name('course.quick_lived'); #course approved
            ...
            Route::get('update/process', 'OtaUpdateController@process')->name('update.process');
    ...
    Route::middleware(['is_verified'])->group(function () {
         ...
         * CUSTOM ROUTES
         */
        Route::post('savelessonJournal','ApiCustomController@SaveJournal');
        Route::get('viewlessonJournal/{id}','ApiCustomController@view_journal');
        Route::get('progressPage','ApiCustomController@progressPage');
        Route::get('progressDetailPage/{id}','ApiCustomController@courseClassProgress');
        Route::post('store_group','GroupsController@store');
        Route::post('update_group','GroupsController@update');
        Route::get('edit_group/{id}','GroupsController@show');
        Route::post('add_member','GroupsController@add_member');
        Route::get('show_student_detail/{id}/{user_id}','ApiCustomController@studentClassProgress');
        Route::post('givePoints','ApiCustomController@givePoints');
        Route::get('checkResults/{id}','ApiCustomController@checkResults');        
        
        /* Route::get('/announcement_instructor', function () {
            return view('admin.announcement.index');
        }); */
        Route::post('add_announcement','AnnouncementTblController@Save');
        Route::get('announcement_instructor','AnnouncementTblController@loadView');
        Route::get('getAnnouncement','AnnouncementTblController@loadinstructorView');
        Route::get('getCourseClass/{id}','ApiCustomController@getCourseClass');
        Route::get('courseclass_delete/{id}','CourseclassController@destroy');
        Route::get('getCourseChapters/{id}','ApiCustomController@getCourseChapters');
        Route::post('chapter_archive','CoursechapterController@archive');
        Route::post('lesson_archive','ApiCustomController@archive');

        Route::get('getCourseClassArchive/{id}','ApiCustomController@getCourseClassArchive');
        Route::post('sort_lesson','CourseclassController@sortLesson');
        Route::get('custom_section','CustomSectionController@loadView');
        Route::get('deleted_messages','DeleteMessagesController@loadView');
        Route::get('getCategories','CategoriesController@getCategories');
        Route::post('add_custom_section','CustomSectionController@Save');
        Route::post('add_delete_message','DeleteMessagesController@Save');
        Route::get('get_custom_section/{id}','CustomSectionController@show');
        Route::get('get_deleted_message/{id}','DeleteMessagesController@show');
        Route::post('/quickupdate/course_live/{id}','QuickUpdateController@courseQuickLive')->name('course.quick_live2'); #course approved
        
        Route::post("admin/country/archive/{id}/{isarchive}","CountryController@archive_country");
        Route::post("admin/course/archive/{id}/{isarchive}","CourseController@archive_country");
        Route::post("admin/faq/archive/{id}/{isarchive}","FaqController@archive_faq");
        Route::post("admin/faq_instructor/archive/{id}/{isarchive}","FaqInstructorController@archive_faq");
        Route::post("admin/pages/archive/{id}/{isarchive}","PageController@archive_page");        

        Route::post("employer/store-job","JobsController@store");
        Route::post("employer/update-job","JobsController@update");
        Route::get("job-detail/{id}","JobsController@JobDetailPage");  
        Route::get("all-jobs","JobsController@JobList");  
        Route::get("edit-job/{id}","JobsController@edit");  
        Route::get("job-listings","JobsController@showJobList");  
        Route::get("employer-detail/{id}","JobsController@employerDetail");  
        Route::get("manage-services","ServiceOfferController@index");  
        Route::post("save-service","ServiceOfferController@store");  
        Route::get("show-service/{id}","ServiceOfferController@show");  
        Route::post("update-service","ServiceOfferController@update"); 
        Route::get("service-listings","ServiceOfferController@showServiceList");  
        Route::get("add-job","JobsController@index"); 
        Route::get("service-detail/{id}","ServiceOfferController@ServiceDetailPage"); 
        Route::post("apply_job","JobApplicationController@store");
        Route::get("manage-jobs-applications","JobApplicationController@index");  
        Route::get("manage-jobs-applications-convo/{id}/{to}/{user_id}","JobApplicationController@showJobApplicationDetail");  
        Route::get("all-applicants/{id}","JobsController@ApplicantList");  
        Route::post("send_message","JobApplicationController@store_convo");

        Route::post("hire_this","JobApplicationController@hire_this_applicant");
        Route::post("apply_service","ServiceRequestApplicationController@store");

        Route::get("manage-services-applications","ServiceRequestApplicationController@index");  
        Route::get("manage-service-applications-convo/{id}/{to}/{employer_id}","ServiceRequestApplicationController@showServiceApplicationDetail");  
        Route::post("send_message_to_user","ServiceRequestApplicationController@store_convo");
        Route::get("offers/{id}","ServiceOfferController@viewOffers");  
...
Route::post('join/employer', 'ApiCustomController@SavePartner');
