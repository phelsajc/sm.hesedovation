                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <div class="footer-link">
                        <ul>
                            ...
                            @php
                                $pages = App\Page::where(['isarchive' => 0])->get();
                            @endphp
                            ...
                            @endforeach
                            @endif
                            <li><a href="{{ url('job-listings') }}" title="Browse Jobs">Browse Jobs</a></li>
                            <li><a href="{{ url('service-listings') }}" title="Browse Services">Browse Services</a></li>
