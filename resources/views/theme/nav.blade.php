                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-6">
                        <div class="Login-btn">
                            ...
                            <a href="{{ route('login') }}" class="btn btn-secondary btn-xs" title="login">{{ __('frontstaticword.Login') }}</a>
                            <a href="{{ route('register') }}" class="btn btn-primary btn-xs" title="register">{{ __('frontstaticword.Signup') }}</a>
                            <a href="{{ url('joinnow') }}" class="btn btn-secondary btn-xs" title="join">Join Now</a>                            
                        </div> 
                    </div>
                @endguest
                          ...
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right User-Dropdown U-open" aria-labelledby="dropdownMenu1">
                                ...
                                @if(Auth::User()->role == "employer")
                                    ...
                                    <a target="_blank" href="{{ url('/admins') }}"><li><i class="fa fa-dashboard"></i>Employer Dashboard</li></a>
                                @endif
                                    <a href="{{ route('mycourse.show') }}"><li><i class="fa fa-diamond"></i>{{ __('frontstaticword.MyCourses') }}</li></a>
                                    <a href="{{ route('wishlist.show') }}"><li><i class="fa fa-heart"></i>{{ __('frontstaticword.MyWishlist') }}</li></a>
                                    <a href="{{ route('purchase.show') }}"><li><i class="fa fa-shopping-cart"></i>{{ __('frontstaticword.PurchaseHistory') }}</li></a>
                                ...
                                @if(Auth::User()->role == "user")
                                    <a href="{{ url('manage-services') }}" title="Watchlist"><li><i class="fas fa-swatchbook"></i>Manage Services</li></a>
                                    <a href="{{ url('manage-jobs-applications') }}" title="Watchlist"><li><i class="fas fa-swatchbook"></i>Job Applications</li></a>
                                @endif

                                @if(Auth::User()->role == "employer")
                                    <a href="{{ url('manage-services-applications') }}" title="Watchlist"><li><i class="fas fa-swatchbook"></i>Services Applications</li></a>
                                @endif
