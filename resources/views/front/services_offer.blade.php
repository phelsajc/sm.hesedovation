...
<section id="blog-home" class="blog-home-main-block">
    <div class="container">
        <h1 class="blog-home-heading text-white">Manage Services</h1>
    </div>
</section> 
...
<section id="profile-item" class="profile-item-block">
    <div class="container">
		...
		<div class="profile-info-block">
			<button type="button" class="btn btn-info btn-xs" onclick="openJobModal()">Post Job</button>
				...
				@if (sizeof($getServices) >0 )
					...
					@foreach ($getServices as $item)
						<tr>
							...
							<td align="center">
								{{date_format(date_create($item->created_dt),'F d, Y')}}
							</td>
							<td align="center">
								<button type="button" class="btn btn-success btn-xs" onclick="edit_service({{$item->id}})">Edit</button>
								
								<a href="{{ url('offers') }}/{{$item->id}}" class="btn btn-success btn-xs">View Offers</a>
								{{-- <a href="{{ url('manage-service-applications-convo') }}/{{$item->id}}" class="btn btn-success btn-xs">View Offers</a> --}}
							</td>
						</tr>
						@php
							$int++;
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<select name="cat[]" id="cat" class="form-control js-example-basic-single" multiple style="width: 100% !important">									
