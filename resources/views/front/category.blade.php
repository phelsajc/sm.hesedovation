...
<section id="business-home-slider" class="business-home-slider-main-block">
    <div class="container">
        <div id="business-home-slider-two" class="business-home-slider owl-carousel">
        	...
        	@if($course->featured == 1 && $course->status == 7)
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="categories-popularity-dtl">
                            ...
                            <ul>
                                @if($course['tags'] == !NULL)
                                <li class="best-seller best-seller-one rgt-5">{{ $course['tags'] }}</li>
                                @endif
                                <li class="rgt-5">
                                	@php
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 ">
                ...
                @php
                    $course_count = App\Course::where(['status'=>'7'])->count();
                @endphp
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="categories-popularity-dtl">
                                    ...
                                    <ul>
                                        @if($course['tags'] == !NULL)
                                            <li class="best-seller best-seller-one">{{ $course['tags'] }}</li>
                                        @endif
                                        <li>
                                            @php
                                                $data = App\CourseClass::where('course_id', $course->id)->get();
