...
<section id="blog-home" class="blog-home-main-block">
    <div class="container">
        <h1 class="blog-home-heading text-white">View Offers</h1>
    </div>
</section> 
		...
		<table class="table table-bordered table-striped">
			...
			<tbody>
				...
				@if (sizeof($getServices) >0 )
					...
					@php
						$getinfo = User::where(['id' => $item->employer_id])->first();
					@endphp
						<tr>
							<td align="center">
								{{$int}}
							...
							<td align="center">
								<a href="{{ url('manage-service-applications-convo') }}/{{$item->service_id}}/{{$item->employer_id}}/{{$item->employer_id}}" class="btn btn-success btn-xs">View Offers</a>
							</td>
						</tr>
						@php
							$int++;
