        ...
        <div class="col-md-6 offset-md-3">
            ...
            <div class="signup-block">
                ...
                <form method="POST" class="signup-form" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        <i class="fa fa-eye" onclick="showPw()" aria-hidden="true"></i>
                        <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }} log_pw" placeholder="Enter Your Password" id="log_pw" name="password" required>
