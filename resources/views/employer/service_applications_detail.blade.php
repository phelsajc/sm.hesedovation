<head>
    ...
    <meta name="title" content="{{$getServiceDetail->title}}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-11 col-sm-11 col-11">
                        <div class="featured-review-img-dtl">
                            @php
                                $getUser = User::where(['id'=>$getServiceApplicationDetail->employer_id])->first();
                            @endphp
                            <div class="review-img-name"><span>{{$getUser->fname}} {{$getUser->lname}}</span></div>
                            <div class="year btm-20">{{ date_format(date_create($getServiceApplicationDetail->date_applied),'jS F Y') }}</div>
                        </div>
                    </div>
                </div>
                <p class="btm-20">{{$getServiceApplicationDetail->message}}</p>   
              <hr>
            </div>
