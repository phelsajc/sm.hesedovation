      ...
      <div class="box box-primary">
        ...
        <div class="panel-body">
           ...
           <form id="demo-form2" method="POST" action="{{route('quiztopic.update', $topic->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <label for="exampleInputTit1e">Chapter<span class="redstar">*</span> </label>
                          <select name="chapter_id" id="chapter_id" class="form-control">   </select>
                        </div>
                      </div>
                      <br>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <label for="exampleInputDetails">Instruction<sup class="redstar">*</sup></label>
                          <textarea name="instruction" rows="3" class="form-control" placeholder="Enter Description"></textarea>
                        </div>
                      </div>
                      <br>
...
<script type="text/javascript">
    ...
    function courseChapter() {
      ...
      $.ajax({
            url: "{{url('/getCourseChapters')}}/"+"{{$topic->course_id}}",
            type: 'get',
            headers: {
            ...
            success: function(data) {
              ...
              data.forEach(element => {
                if("{{$topic->section_id}}"==element.id){
                  $("#chapter_id").append("<option selected value='"+element.id+"'>"+element.chapter_name+"</option>")
                }else{
                  $("#chapter_id").append("<option value='"+element.id+"'>"+element.chapter_name+"</option>")
                }
              });
              $("#chapter_id").select2()
            },
