              ...
              <tr>
                ...
                <td>
                  <?php 
                    ...
                    $check_cc = CourseChapter::where(['id'=>$topic->section_id])->first();
                    echo $check_cc['chapter_name'];
                  ?>
                </td>
                <td>{{$topic->title}}</td>
              ...
              <form id="demo-form2" method="post" action="{{url('admin/quiztopic/')}}" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <select name="chapter_id" id="chapter_id" class="form-control select2">
                      @foreach ($coursechapters as $item)
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <input type="number" placeholder="Points to allocate this quiz" class="form-control " name="per_q_mark" id="exampleInputTitle" value="">
                  </div>
                </div>
                <br>
