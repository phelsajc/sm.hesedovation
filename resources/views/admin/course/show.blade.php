        ...
        <div class="box-body">
          <div class="nav-tabs-custom">
            <div class="row">
              ...
              <li  class=""  role="presentation"><a href="#c" aria-controls="messages" role="tab" data-toggle="tab">What To Learn</a></li>
              <li  class=""  role="presentation"><a href="#d" aria-controls="settings" role="tab" data-toggle="tab">Chapter & Lessons</a></li>
              {{-- <li  class=""  role="presentation"><a href="#e" aria-controls="settings" role="tab" data-toggle="tab">{{ __('adminstaticword.CourseClass') }}</a></li> --}}
              ...
              <li  class=""  role="presentation"><a href="#groups" aria-controls="groups" role="tab" data-toggle="tab">Groupings</a></li>
              ...
              <div role="tabpanel" class="fade tab-pane" id="groups">
                @include('admin.course.groupings.index')
              </div>
