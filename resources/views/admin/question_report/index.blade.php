                ...
                @foreach($items as $item)
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a title="Delete" data-toggle="modal" data-target="#report_question{{ $item->id }}" class="btn btn-danger btn-sm">
                    ...
                    <div id="report_question{{ $cpn->id }}" class="delete-modal modal fade" role="dialog">
                      <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                               <form method="post" action="{{url('user/question/report'. $item->id)}} class="pull-right">
                                  {{csrf_field()}}
                                  {{method_field("DELETE")}}
