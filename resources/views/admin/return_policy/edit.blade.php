                ...
                <form id="demo-form2" method="post" action="{{url('refundpolicy/'.$return->id)}}" data-parsley-validate class="form-horizontal form-label-left"  enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" name="title" id="exampleInputTitle"value="{{$return->name}}">
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <textarea name="details" rows="5" id="editor2" class="form-control" >{{$return->detail}}</textarea>
                    </div>
                  </div>
                  <br>
