          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            @foreach($faq as $key=>$p)
              <tr>
                ...
                <td>
                  <a class="btn btn-success btn-sm" href="{{url('faq/'.$p->id.'/edit')}}">
                    <i class="glyphicon glyphicon-pencil"></i></a>
                    <a title="Delete coupon" data-toggle="modal" data-target="#faq{{ $p->id }}" class="btn btn-danger btn-sm">
                ...
                <div id="faq{{ $p->id }}" class="delete-modal modal fade" role="dialog">
              ...
              <div id="archive_faq{{ $p->id }}" class="delete-modal modal fade" role="dialog">
                <div class="modal-dialog modal-sm">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                         <form method="post" action="{{url('admin/faq/archive/'.$p->id)}}/1" class="pull-right">
                            {{csrf_field()}}
                            {{method_field("POST")}}
                         <button type="reset" class="btn btn-gray translate-y-3" data-dismiss="modal">No</button>
                        <button type="submit" class="btn btn-danger">Yes</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        @php
        $faq_archive = App\FaqStudent::where(['isarchive'=>1])->get();
      @endphp
              ...
              @foreach ($faq_archive as $item)
                  <tr>
                    ...
                    <td>
                      ...
                      <form method="post" action="{{url('admin/faq/archive/'.$item->id)}}/0" class="pull-right">
                        {{csrf_field()}}
                        {{method_field("POST")}}
