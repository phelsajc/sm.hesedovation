          ...
          <form action="{{ route('user.update',$user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6">
                  ...
                  <textarea name="address" class="form-control" rows="1"  placeholder="Enter address" value="">{{ $user->address }}</textarea>
              </div>
            ...
            <div class="row display-none" id="update-password">
              <div class="col-md-6">
                ...
                <input type="password" name="password" class="form-control log_pw" placeholder="Enter password"> --}}

                <label>{{ __('adminstaticword.Password') }}</label>
                <div class="form-group">
                  <div class="col-md-6">
                    <input type="password" name="password" id="password" onchange="chekcpw()" class="form-control log_pw" placeholder="Enter password">
                    <span toggle="#password-field" onclick="showPw()" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <div class="col-md-6">
                    <input type="password" name="confirmpassword" id="confirmpassword" onchange="chekcpw()" class="form-control log_pw" placeholder="Confirm password">
                    <span toggle="#password-field" onclick="showPw()" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                  </div>
                </div>
              </div>
            ...
            <div class="box-footer">
              <button type="submit" id="btnSave" class="btn btn-md btn-primary">
