                        ...
                        <td>
                          <a class="btn btn-success btn-sm" href="{{ route('user.update',$user->id) }}">
                            ...
                            <form  method="post" action="{{ route('user.delete',$user->id) }}
                              ...
                              {{ method_field('DELETE') }}   
                              @php        
                                $get_message = Delete_messages::where('module',1)->first();
                              @endphp
                                <button onclick="return confirm('{{$get_message->text}}')"  type="submit" class="btn btn-danger btn-sm"><i class="fa fa-fw fa-trash-o"></i></button>
                              </form>
                        </td>
