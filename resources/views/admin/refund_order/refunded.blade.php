  ...
  <div class="table-responsive">
    <table id="example1" class="table table-bordered table-striped">
      ...
      <tr>
        ...
        <th>{{-- {{ __('adminstaticword.View') }} --}}Action</th>
      ...
      <tr>
        ...
        <td><a class="btn btn-success btn-sm" href="{{url('refundorder/'.$refund->id.'/edit')}}">
          view</a>
          <a title="Delete coupon" data-toggle="modal" data-target="#refunded{{ $refundorder->id }}" class="btn btn-danger btn-sm">
        ...
        <div id="refunded{{ $refund->id }}" class="delete-modal modal fade" role="dialog">
