          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody id="sortable">
              ...
              <tr class="sortable" id="id-{{ $cat->id }}">
                ...
                <td><a class="btn btn-warning btn-sm" href="{{url('slider/'.$cat->id)}}">
                  <i class="glyphicon glyphicon-pencil"></i></a>
                  <a title="Delete" data-toggle="modal" data-target="#slider{{ $cat->id }}" class="btn btn-danger btn-sm">
                ...
                <div id="slider{{ $cat->id }}" class="delete-modal modal fade" role="dialog">
                  <div class="modal-dialog modal-sm">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                           <form method="post" action="{{url('slider/'.$cat->id)}} class="pull-right">
                              {{csrf_field()}}
                              {{method_field("DELETE")}}
