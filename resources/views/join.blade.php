    ...
    <div class="container">
        <div class="col-lg-6 col-md-8 offset-md-3">
            ...
            <div class="signup-block">
                ...
                <form class="signup-form" method="POST" action="{{ url('join/employer') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        <select name="noemp" id="noemp" class="form-control">
                            <option selected disabled value="0">No. of Employees</option>
                            <option value="1">Only Me</option>
                            <option value="2">2-9 Employees</option>
                            <option value="3">10-99</option>
                            <option value="4">100-499</option>
                            <option value="5">more than 500 Employees</option>
                        </select>
                    </div>
