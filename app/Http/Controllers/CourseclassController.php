...
class CourseclassController extends Controller
{
    ...
    { 
        ...
        {
            $courseclass->type = "journal";            
        }

        
        if($request->type == "article")
        {
            $courseclass->type = "article";            
        }
    ...
    public function show( $id)
    {
        ...
        return view('admin.course.courseclass.edit',compact('cate','coursechapt','subtitles', 'live_date','orders')); 
   ...
   {
       foreach ($request->lesson_sort as $key => $value) {
            CourseClass::where(['id' => $value])->update([
                'sort' => $key,        
            ]);
       }
       echo true;
