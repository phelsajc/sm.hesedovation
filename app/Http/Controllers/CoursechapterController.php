...
class CoursechapterController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function showLessons( $id, $course_id)
    {
        $cate = CourseChapter::find($id);
        $courses = Course::all();
        $coursechapter = CourseChapter::all();
        return view('admin.course.coursechapter.lessons',compact('cate','courses','coursechapter'));
    }
    ...
    {
        $q = CourseChapter::find($request->id);
