    ...
    public function categoryPage(Request $request)
    {
        ...
        if($request->type){
          ...
          if($request->sortby == 'l-h'){
            ...
            $courses = $cats->courses()->where(['status'=>'7'])->where('type','=','1')->orderBy('price','DESC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'h-l'){
            ...
            $courses = $cats->courses()->where(['status'=>'7'])->where('type','=','1')->orderBy('price','ASC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'a-z'){
            ...
            if($request->type)
            {
              $courses = $cats->courses()->where(['status'=>'7'])->where('type','=',$request->type == 'paid' ? 1 : 0)->orderBy('title','ASC')->paginate($request->limit ?? 10);
            }
            else{

              $courses = $cats->courses()->where(['status'=>'7'])->orderBy('title','ASC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'z-a'){
            ...
            if($request->type)
            {
              $courses = $cats->courses()->where(['status'=>'7'])->where('type','=',$request->type == 'paid' ? 1 : 0)->orderBy('title','DESC')->paginate($request->limit ?? 10);
            }
            else{

              $courses = $cats->courses()->where(['status'=>'7'])->orderBy('title','DESC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'newest'){
            ...
            if($request->type){
              ...
              $courses = $cats->courses()->where(['status'=>'7'])->where('type','=',$request->type == 'paid' ? 1 : 0)->orderBy('created_at','DESC')->paginate($request->limit ?? 10);

              
            }else{

              $courses = $cats->courses()->where(['status'=>'7'])->orderBy('created_at','DESC')->paginate($request->limit ?? 10);
          ...
          if($request->sortby == 'featured'){
            ...
            if($request->type)
            {
              $courses = $cats->courses()->where(['status'=>'7'])->where('type','=',$request->type == 'paid' ? 1 : 0)->where('featured','=', '1')->paginate($request->limit ?? 10);
            }
            else{

              $courses = $cats->courses()->where(['status'=>'7'])->where('featured','=', '1')->paginate($request->limit ?? 10);
          ...
          if($request->limit == '10'){
            ...
            $courses = $cats->courses()->where(['status'=>'7'])->paginate(2);

          }
          elseif($request->limit == '30'){

            $courses = $cats->courses()->where(['status'=>'7'])->paginate($request->limit);
          ...
          elseif($request->limit == '100'){
            ...
            $courses = $cats->courses()->where(['status'=>'7'])->paginate($request->limit ?? 10);
          ...
          $courses = $cats->courses()->where(['status'=>'7'])->where('language_id','=',$lang->id)->paginate($request->limit ?? 10);
