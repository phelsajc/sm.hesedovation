...
exit; */
        ...
        { 
            $courses =  array();            
            $getCourseDetail = Course::where('id', $cart->course_id)->first();
            $courses['courses'] = $getCourseDetail ->title;
            $getCourses[] = $courses;
        ...
        //dd($user);
        /* foreach ($user['course'] as  $value) {
            echo $value['courses'].'<br>';
        }
        exit; */
        Mail::to("isaactan777@gmail.com")->send(new CourseOrder($user));
